...
**Layout.** No sidebar, no page scrolling, and no explanatory captions under
charts — the **Dashboard** tab is a dense nine-card grid showing everything at
once, with the detail tabs behind it. Every view fits a
...
| Tab | What it answers |
|---|---|
| **Dashboard** | Dense landing grid — nine compact cards covering every argument the dashboard makes, on one screen |
